      ...
      <section>
        <div class="bg-white relative border-gray-400 border-b-[1px]">
          ...
          <div class="w-[90%] mx-auto mt-[1px] cursor-pointer hover:bg-sky-100 px-1 rounded" v-if="number > 0"
            ...
            <span v-if="varBool && number > 1" class="text-gray-600 text-[13px]">Vous et {{ number - 1 }} autre(s)
              personne(s) ont aimé cette
              photo.</span>
            <span v-else-if="varBool && number == 1" class="text-gray-600 text-[13px]">Vous avez aimé cette photo.</span>
            <span v-else-if="number == 1" class="text-gray-600 text-sm">{{ number }} personne a aimé cette
              photo.</span>
            <span v-else class="text-gray-600 text-[13px]">{{ number }} personne(s) ont aimé cette photo.</span>
          </div>
          ...
          <div class="bg-white fixed bottom-0 left-0 right-0 rounded-l-lg rounded-r-lg py-2 z-50">
